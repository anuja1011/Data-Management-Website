...
<body>
			...
			<li>
				<div class="dropdown">
					...
					<% if (session.getAttribute("userType")==null || session.getAttribute("userType").equals("a")){%>
						...
						<a href="Report3.jsp">Generate Report 3</a>
	...
	<div class="content">
		...
		<table class="table">
			...
			<%ArrayList<ReportsPOJO> arr_rep = (ArrayList<ReportsPOJO>)request.getAttribute("report3"); %>
			...
			<tr>
				...
				<td>
				<%=arr_rep.get(x).getAmount_redeemed() %>
				</td>
				<td>
